...
A `LICENSE-karakeep` file may sit beside this one. That is the original's licence text
...
This is a clean-room implementation of [karakeep-app/karakeep](https://github.com/karakeep-app/karakeep), Copyright
the karakeep-app/karakeep authors, licensed under AGPL-3.0. It was written against a specification derived
by running that system and recording what it does, not by translating its source. See
`../karakeep-port/specs/SPEC-001-karakeep.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for any text carried
across and why.
